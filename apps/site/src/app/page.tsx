...
export default function Home() {
  return (
    <div className="bg-gradient-to-b from-violet-100 via-purple-100 min-h-screen">
      <header className="container mx-auto p-4 mb-14 flex justify-between">
        <Link href="/">
      ...
      <main className="container mx-auto">
        ...
        <div className="text-sm text-slate-600 mt-14">
          <p>How it works: </p>
          <br />
